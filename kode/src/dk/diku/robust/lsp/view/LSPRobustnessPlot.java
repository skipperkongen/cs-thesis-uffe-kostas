...
public class LSPRobustnessPlot extends AbsMultiDoublePlot {
	
	public LSPRobustnessPlot() {
		super(false);
		setChartTitle("Robustness");
		setXLabel("Generation");
		setYLabel("Robustness");
	}
	...
	public void update(Observable observable, Object obj) {
		if(observable instanceof SolverRunner) {
			...
			for(SolutionData sol : solutions) {
				...
				addPoint(""+solutionID, x, conclusion.robustnessLB);
				solutionID++;
			}
		}
