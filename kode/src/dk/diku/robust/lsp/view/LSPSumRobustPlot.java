...
public class LSPSumRobustPlot extends AbsMultiDoublePlot {
	
	public LSPSumRobustPlot() {
		super(true);
		setChartTitle("Num robust solutions...");
		setXLabel("Generation");
		setYLabel("Num robust solutionst");
	}
	...
	public void update(Observable observable, Object obj) {
		if(observable instanceof SolverRunner) {
			...
			addPoint("Number of robust solutions", x, numRobust);
		}
